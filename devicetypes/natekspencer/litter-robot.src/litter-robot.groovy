    ...
    tiles(scale: 2) {
        multiAttributeTile(name: "robotCleanerMovement", type: "generic", width: 6, height: 4) {
            tileAttribute("device.robotCleanerMovement", key: "PRIMARY_CONTROL") {
                ...
                attributeState "DF1"    , label: 'Drawer Full'                                                                     , backgroundColor: "#e86d13", icon: "https://raw.githubusercontent.com/natekspencer/LitterRobotManager/master/images/litter-robot@3x.png"
                attributeState "DF2"    , label: 'Drawer Full'                                                                     , backgroundColor: "#e86d13", icon: "https://raw.githubusercontent.com/natekspencer/LitterRobotManager/master/images/litter-robot@3x.png"
                attributeState "DFS"    , label: 'Drawer Full'                                                                     , backgroundColor: "#bc2323", icon: "https://raw.githubusercontent.com/natekspencer/LitterRobotManager/master/images/litter-robot@3x.png"
